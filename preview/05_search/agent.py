...
You help users find relevant automation recipes by calling the search_recipe tool.
...
When answering:
- Always call search_recipe before answering recipe-related questions.
...
def run_agent(user_message: str) -> str:
    ...
    while True:
        ...
        for tc in tool_calls:
            ...
            print(
                f"[tool] search_recipe(query={query!r}, "
