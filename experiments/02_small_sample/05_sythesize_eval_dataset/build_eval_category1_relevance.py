"""
build_eval_category1_relevance.py
===================================

Phase 2 of the Category 1 evaluation dataset pipeline.
Run this AFTER reviewing the queries printed by build_eval_category1_queries.py.

What this script does
---------------------
1. Loads eval_category1_queries.json (Phase 1 output).
...
6. Writes rows to eval_category1.csv incrementally and saves a checkpoint
...
Inputs
------
  05_sythesize_eval_dataset/eval_category1_queries.json   (Phase 1 output)
...
------
  ...
  05_sythesize_eval_dataset/eval_category1_checkpoint.json   (resume state — delete to restart)
...
QUERIES_PATH = BASE_DIR / "eval_category1_queries.json"
OUTPUT_PATH  = BASE_DIR / "eval_category1.csv"
CHECKPOINT   = BASE_DIR / "eval_category1_checkpoint.json"
...
A business user typed a search query. You are given a set of Workato \
recipes.
...
def main():
    if not QUERIES_PATH.exists():
        raise FileNotFoundError(
            f"{QUERIES_PATH} not found. Run build_eval_category1_queries.py first."
        )
