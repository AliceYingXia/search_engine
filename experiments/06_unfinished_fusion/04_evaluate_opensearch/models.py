...
MODEL_REGISTRY: dict[str, ModelConfig] = {
    ...
    "Qwen/Qwen3-Embedding-8B-full": ModelConfig(
    ...
    "Qwen/Qwen3-Embedding-8B-full+instruct": ModelConfig(
        table="embeddings_qwen3_embedding_8b_full",   # same doc vectors as base
        backend="baseten_predict_batch",
        predict_url="https://model-wom8ozkq.api.baseten.co/environments/production/predict",
        instruction=(
            "Instruct: Retrieve the most relevant automation workflow recipe "
    ...
    "Qwen/Qwen3-Embedding-8B-2000": ModelConfig(
        table="embeddings_qwen3_embedding_8b_2000",
        dimension=4096,
        backend="baseten_predict_batch",
        predict_url="https://model-wom8ozkq.api.baseten.co/environments/production/predict",
        store_dim=2000,
    ...
    "Qwen/Qwen3-Embedding-8B-2000+instruct": ModelConfig(
        table="embeddings_qwen3_embedding_8b_2000",   # same doc vectors as base
        backend="baseten_predict_batch",
        predict_url="https://model-wom8ozkq.api.baseten.co/environments/production/predict",
        instruction=(
            "Instruct: Retrieve the most relevant automation workflow recipe "
