...
def main():
    ...
    if summary_path.exists():
        ...
        if "search_mode" in existing.columns:
            remove_mask = existing["model"].isin(args.model) & existing["search_mode"].eq(args.search_mode)
        else:
            remove_mask = existing["model"].isin(args.model)
