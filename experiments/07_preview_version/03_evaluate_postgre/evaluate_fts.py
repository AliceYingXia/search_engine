...
-----
    ...
    python pipeline/03_evaluate_postgre/evaluate_pgfts.py

    # simple (basic) config
    python pipeline/03_evaluate_postgre/evaluate_pgfts.py --config simple

    # specific categories or k
    python pipeline/03_evaluate_postgre/evaluate_pgfts.py --category 1 2
    python pipeline/03_evaluate_postgre/evaluate_pgfts.py --config simple --category 3 --k 10
